...
const ErrorLogin = ({ err }: any) => {
  let errMessage;
  switch (err) {
    case "OAuthAccountNotLinked":
      errMessage = `Cet email est lié à un autre fournisseur. Utilisez le même compte que lors de votre inscription`;
      break;

    default:
      errMessage = `${err} , contact : contact@quebra.co`;
      break;
  }
  return (
    <div className="mb-10 w-full rounded-md bg-red-600 px-2 py-1 font-mono text-sm normal-case text-white">
